...
;;  $Id: color-occur.el,v 2.0 2004/08/10 02:00:29 akihisa Exp $
...
(setq list-matching-lines-face 'color-color-face)
            ...
            (while (re-search-forward before-occur-word nil t)
              (progn
                (setq ov (make-overlay (match-beginning 0)
                                       (match-end 0)))
                (overlay-put ov 'face 'color-color-face)
