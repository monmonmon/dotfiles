...
(defvar rst-compile-toolsets
  '((html . ("rst2html-2.6.py" ".html" nil))
    (latex . ("rst2latex-2.6.py" ".tex" nil))
    (newlatex . ("rst2newlatex-2.6.py" ".tex" nil))
    (pseudoxml . ("rst2pseudoxml-2.6.py" ".xml" nil))
    (xml . ("rst2xml-2.6.py" ".xml" nil))
    (pdf . ("rst2pdf-2.6.py" ".pdf" nil))
    (s5 . ("rst2s5-2.6.py" ".xml" nil)))
...
;;      '("rst2html-2.6.py" ".htm" "--stylesheet=/docutils.css"))
